...
operator fun <T> Player.set(property: Property<T>, value: T?) = PlayerPropertyAdapter.set(this, property, value)
operator fun <T> Player.contains(property: Property<T>): Boolean = PlayerPropertyAdapter.contains(this, property)
fun <T> Player.remove(property: Property<T>): T? = PlayerPropertyAdapter.remove(this, property)